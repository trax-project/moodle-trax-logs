 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class hvp_internal_event_triggered extends \core\event\base {
    ...
    public static function create_statement(\stdClass $statement) {
        ...
        $iri = $statement->context->contextActivities->parent[0]->id;
    ...
    {
        return get_string('event_hvp_internal_triggered', 'logstore_trax');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' interacted inside the H5P activity with id '$this->contextinstanceid'.";
    }
