...
/**
 * H5P xAPI event: interactive video summary answered.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class hvp_video_summary_answered extends hvp_event {
    ...
    public static function get_name() {
        return get_string('event_hvp_video_summary_answered', 'logstore_trax');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' answered the summary
